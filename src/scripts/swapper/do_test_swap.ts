...
import { getSwapLimits, MAX_SLIPPAGE, REFERRAL_NAME } from '../../config'
...
;(async () => {
    ...
    const swapParams: SwapParams = {
        ...
        referralName: config.referralName,
    }
    ...
    const monitorInterval = setInterval(async () => {
        ...
        const highloadBalances = await getBalances(tonClient, highloadAddress, assetsCollection, jettonWallets)
