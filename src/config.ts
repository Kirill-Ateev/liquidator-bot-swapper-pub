...
export const HIGHLOAD_CODE_V2 = Cell.fromBase64(
...
export const EXTENDED_ASSET_LIST = ['ton', 'jusdc', 'jusdt', 'stton', 'tston', 'usdt', 'tonusdt_dedust', 'tonusdt_stonfi', 'ton_storm', 'usdt_storm']
...
export const REFERRAL_NAME = 'user_UQBqousX5067xRULZlKJTXM4JheeDI9lq1jEV78aBpcKXFJR'
